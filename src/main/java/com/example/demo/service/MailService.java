...
public class MailService {
    ...
    public void sendSimpleMail() throws Exception {
        ...
        message.setFrom("553900669@qq.com");
        message.setTo("553900669@qq.com");
    ...
    public void sendAttachmentsMail() throws Exception {
        ...
        helper.setFrom("553900669@qq.com");
        helper.setTo("553900669@qq.com");
    ...
    public void sendModelMails() throws  Exception {
        ...
        Template t = configuration.getTemplate("ftl/mail.ftl"); // freeMarker template
